...
// (DO NOT EDIT: machine generated header) 'IdFTP.pas' rev: 4.00
...
__published:
	...
	__property Idftplist::TIdOnParseCustomListFormat OnParseCustomListFormat = {read=FOnParseCustomListFormat
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdFTPFileAlreadyExists(int Ident, Extended Dummy) : Idexception::EIdException(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdFTPFileAlreadyExists(int Ident, const System::TVarRec 
