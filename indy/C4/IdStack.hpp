...
// (DO NOT EDIT: machine generated header) 'IdStack.pas' rev: 4.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdStackError(int Ident, Extended Dummy) : Idexception::EIdException(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdStackError(int Ident, int AHelpContext) : Idexception::EIdException(
		Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdStackError(int Ident, const System::TVarRec * 
		Args, const int Args_Size, int AHelpContext) : Idexception::EIdException(Ident, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdStackInitializationFailed(int Ident, Extended Dummy)
		 : EIdStackError(Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdStackInitializationFailed(int Ident, const System::TVarRec 
		* Args, const int Args_Size) : EIdStackError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdStackInitializationFailed(int Ident, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : EIdStackError(Ident, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdStackSetSizeExceeded(int Ident, Extended Dummy) : EIdStackError(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdStackSetSizeExceeded(int Ident, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : EIdStackError(Ident, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdInvalidIPAddress(int Ident, Extended Dummy) : EIdStackError(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdInvalidIPAddress(int Ident, int AHelpContext) : 
		EIdStackError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdInvalidIPAddress(int Ident, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : EIdStackError(Ident, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
