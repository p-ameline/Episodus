...
// (DO NOT EDIT: machine generated header) 'IdUDPServer.pas' rev: 4.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdUDPServerException(int Ident, Extended Dummy) : Idudpbase::EIdUDPException(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdUDPServerException(int Ident, const System::TVarRec 
		* Args, const int Args_Size) : Idudpbase::EIdUDPException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdUDPServerException(int Ident, int AHelpContext) : 
		Idudpbase::EIdUDPException(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdUDPServerException(int Ident, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Idudpbase::EIdUDPException(Ident, Args, Args_Size
		, AHelpContext) { }
	#pragma option pop
