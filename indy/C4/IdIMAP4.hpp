...
// (DO NOT EDIT: machine generated header) 'IdIMAP4.pas' rev: 4.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdNumberInvalid(int Ident, Extended Dummy) : Sysutils::Exception(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdNumberInvalid(int Ident, int AHelpContext) : Sysutils::Exception(
		Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdNumberInvalid(int Ident, const System::TVarRec 
...
protected:
	...
	void __fastcall ParseBodyStructurePart(AnsiString APartString, Idmessage::TIdMessagePart* AThePart, 
		TIdImapMessagePart* AImapPart, TIdImapSubSection* AImapSubSection);
	...
	void __fastcall ParseLSubResult(Classes::TStringList* AMBList, Classes::TStrings* CmdResultDetails)
		;
	void __fastcall InternalParseListResult(AnsiString ACmd, Classes::TStringList* AMBList, Classes::TStrings* 
		CmdResultDetails);
	...
	bool __fastcall InternalRetrieve(const int AMsgNum, bool AUseUID, bool AUsePeek, Idmessage::TIdMessage* 
		AMsg);
...
public:
	...
	bool __fastcall AppendMsg(const AnsiString AMBName, Idmessage::TIdMessage* AMsg, const Idmessage::TIdMessageFlagsSet 
		AFlags)/* overload */;
	bool __fastcall AppendMsg(const AnsiString AMBName, Idmessage::TIdMessage* AMsg, Idheaderlist::TIdHeaderList* 
		AAlternativeHeaders, const Idmessage::TIdMessageFlagsSet AFlags)/* overload */;
