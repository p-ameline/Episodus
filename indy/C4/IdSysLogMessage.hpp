...
// (DO NOT EDIT: machine generated header) 'IdSysLogMessage.pas' rev: 4.00
...
enum TIdSyslogFacility { sfKernel, sfUserLevel, sfMailSystem, sfSystemDaemon, sfSecurityOne, sfSysLogInternal, 
	sfLPR, sfNNTP, sfUUCP, sfClockDaemonOne, sfSecurityTwo, sfFTPDaemon, sfNTP, sfLogAudit, sfLogAlert, 
