...
// (DO NOT EDIT: machine generated header) 'IdFTPList.pas' rev: 4.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdInvalidFTPListingFormat(int Ident, Extended Dummy) : 
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdInvalidFTPListingFormat(int Ident, const System::TVarRec 
