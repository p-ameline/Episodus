...
// (DO NOT EDIT: machine generated header) 'IdFTPServer.pas' rev: 4.00
...
typedef void __fastcall (__closure *TOnPASVEvent)(TIdFTPServerThread* ASender, AnsiString &VIP, Word 
	&VPort);
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdFTPServerException(int Ident, Extended Dummy) : Idexception::EIdException(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EIdFTPServerException(int Ident, int AHelpContext) : 
		Idexception::EIdException(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdFTPServerException(int Ident, const System::TVarRec 
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdFTPServerNoOnListDirectory(int Ident, Extended Dummy
		) : EIdFTPServerException(Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdFTPServerNoOnListDirectory(int Ident, const System::TVarRec 
		* Args, const int Args_Size) : EIdFTPServerException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	/* Exception.CreateResHelp */ inline __fastcall EIdFTPServerNoOnListDirectory(int Ident, int AHelpContext
		) : EIdFTPServerException(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdFTPServerNoOnListDirectory(int Ident, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : EIdFTPServerException(Ident, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
