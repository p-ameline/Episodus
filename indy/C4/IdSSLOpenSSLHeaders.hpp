...
// (DO NOT EDIT: machine generated header) 'IdSSLOpenSSLHeaders.pas' rev: 4.00
...
extern PACKAGE void __cdecl (*IdDES_ecb_encrypt)(const Byte * Input, const Byte * output, const des_ks_struct 
	* ks, int enc);
