...
NSLdvWindowToon::NSLdvWindowToon(NSContexte* pCtx, NSLdvWindowToon* parent, NSLdvViewBase* pTheView)
...
NSLdvCommandPannel::NSLdvCommandPannel(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvViewBase* pTheView)
...
NSLdvChronoLine::NSLdvChronoLine(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvViewBase* pTheView)
                :NSLdvWindowToon(pCtx, pLdvParent, pTheView)
{
  lObjectCount++ ;
...
NSLdvCurveYAxis::NSLdvCurveYAxis(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvViewBase* pView, NSLdvCurve* pTheCurve)
...
NSLdvCurveBackgroundQuadri::NSLdvCurveBackgroundQuadri(NSLdvViewBase* pVw)
{
  lObjectCount++ ;
...
NSLdvCurveBackgroundQuadri::NSLdvCurveBackgroundQuadri(NSLdvViewBase* pVw, NS_CLASSLIB::TColor qColor, NVLdVTemps beginDate, NVLdVTemps endDate, double lowerValue, string lowerUnit, double upperValue, string upperUnit)
{
  lObjectCount++ ;
...
NSLdvCurvesManagementPannel::NSLdvCurvesManagementPannel(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvViewBase* pView)
                            :NSLdvWindowToon(pCtx, pLdvParent, pView)
{
  lObjectCount++ ;
...
{
  NSLdvViewBase* pView = _pCurvesPannel->getView() ;
  if ((NSLdvViewBase*) NULL == pView)
    return ;
  ...
  if ((ArrayOfToons*) NULL == pToonsArray)
    return ;
...
NSCurvesProperty::NSCurvesProperty(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvViewBase* pTheView)
                 :NSLdvWindowToon(pCtx, pLdvParent, pTheView)
{
  lObjectCount++ ;
...
{
  if ((OWL::TPopupMenu*) NULL == _pPopupMenu)
    return false ;

  NSMDIFrameBase* pFrame = (NSMDIFrameBase*) pContexte->getSuperviseur()->getApplication()->getFrame() ;
...
NSLdvViewIconsShowWindow::closeOpenObject()
{
  ...
  // Tell Documents manager to consider this document as closed + Close window
  //
...
NSLdvViewIconsShowWindow::XmlExport()
{
  ...
  if ((NSDocumentHisto*) NULL == pActiveDocHisto)
    return ;

  // pContexte->getPatient()->DocumentXmlExport(pActiveDocHisto) ;

  NSToDoTask* pTask = new NSToDoTask ;
  pTask->setWhatToDo(string("ExportDocument")) ;
  pTask->setParam1(pActiveDocHisto->getID()) ;
  pTask->sendMe(pContexte->getSuperviseur()) ;
}
...
NSLdvViewIconsShowWindow::Ouvrir()
{
  ...
  //
  if (((NsObjectIcon*) NULL == _ActiveObject) || (NULL == _ActiveObject->getObject()))
    return ;

  NSLdvObjet* pLdvObject = _ActiveObject->getObject()->getObject() ;
  if ((NSLdvObjet*) NULL == pLdvObject)
    return ;

  // Get access to NSLdvDocument
  //
  if (((NSLdvViewAreaWindow*) NULL == _pParent) || (NULL == _pParent->getView()))
    return ;

  NSLdvDocumentBase *pLdvDoc = _pParent->getView()->getDoc() ;
...
/*
  ...
  if ((NSHISTODocument*) NULL == pDocHisto)
    return ;
...
*/
  ...
  NSToDoTask* pTask = new NSToDoTask ;
  pTask->setWhatToDo(string("EditDocument")) ;
  pTask->setParam1(pActiveDocHisto->getID()) ;
  pTask->sendMe(pContexte->getSuperviseur()) ;
}
