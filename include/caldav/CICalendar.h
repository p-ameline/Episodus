...
typedef vector<CICalendarComponentRecur*> CICalendarComponentRecurs;

class CICalendarComponentExpanded;
typedef cdsharedptr<CICalendarComponentExpanded> CICalendarComponentExpandedShared;
typedef vector<CICalendarComponentExpandedShared> CICalendarExpandedComponents;
...
public:
	...
	CICalendarComponent*	ParseComponent(istream& is, const cdstring& rurl, const cdstring& etag);
	virtual void			Generate(ostream& os, bool for_cache = false) const;
	virtual void			GenerateOne(ostream& os, const CICalendarComponent& comp) const;
...
protected:
	typedef map<CICalendarRef, CICalendar*>	CICalendarRefMap;
	...
	void	Generate(ostream& os, const CICalendarComponentDB& components, bool for_cache) const;
...
private:
	...
	typedef map<cdstring, SComponentRegister*> CComponentRegisterMap;
...
typedef vector<CICalendar*> CICalendarList;
