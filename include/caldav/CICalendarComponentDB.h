...
typedef map<cdstring, CICalendarComponent*> CICalendarComponentMap;
...
protected:
	typedef map<cdstring, CICalendarDateTimeList> CICalendarRecurrenceMap;
...
typedef vector<const CICalendarComponentDB*> CICalendarComponentDBList;
