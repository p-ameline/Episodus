...
typedef vector<CICalendarDateTime> CICalendarDateTimeList;
...
protected:
	...
	typedef map<cdstring, CICalendarValue::EICalValueType>	CValueTypeMap;
	static CValueTypeMap		sDefaultValueTypeMap;
	static CValueTypeMap		sValueTypeMap;

	typedef map<CICalendarValue::EICalValueType, cdstring>	CTypeValueMap;
...
typedef multimap<cdstring, CICalendarProperty> CICalendarPropertyMap;
typedef vector<CICalendarProperty> CICalendarPropertyList;
