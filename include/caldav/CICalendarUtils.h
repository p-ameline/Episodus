...
{
public:
	typedef vector<vector<int32_t> > CICalendarTable;

	static bool	ReadFoldedLine(istream& is, cdstring& line1, cdstring& line2);

	static void WriteTextValue(ostream& os, const cdstring& value);
	...
	// Display elements
	static void		GetMonthTable(const int32_t month, const int32_t year, const CICalendarDateTime::EDayOfWeek weekstart, CICalendarTable& table, pair<int32_t, int32_t>& today_index);
