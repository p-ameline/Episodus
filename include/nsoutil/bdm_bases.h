...
class _NSOUTILCLASSE NSBdmData{
  public:
...
//---------------------------------------------------------------------------
class _NSOUTILCLASSE NSBdmInfo
{
  public:
...
//---------------------------------------------------------------------------
//
class _NSOUTILCLASSE NSBdm : public NSBdmInfo, public NSFiche
{
  public:
...
class _NSOUTILCLASSE NSBdmArray : public NSBMArray
{
  public:
