...
#ifndef __ADEPUL_FU_HAV_FKS_H__
#define __ADEPUL_FU_HAV_FKS_H__
...
class Adepul_FU_HAV_FKS : public AbstractKS
{
 public:
	Adepul_FU_HAV_FKS() { } ;
	~Adepul_FU_HAV_FKS() { } ;
...
#  else
		 ...
		 Adepul_FU_HAV_FKS        ks ;
#  endif
# else
		 extern TModule       		*pNSResModule ;
		 extern Adepul_FU_HAV_FKS	ks ;
# endif

#endif  // __ADEPUL_FU_HAV_FKS_H__
