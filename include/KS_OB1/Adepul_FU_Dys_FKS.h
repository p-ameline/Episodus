...
#ifndef __ADEPUL_FU_DYS_FKS_H__
#define __ADEPUL_FU_DYS_FKS_H__
...
class Adepul_FU_Dys_FKS : public AbstractKS
{
 public:
...
#  else
		 ...
		 Adepul_FU_Dys_FKS        ks ;
#  endif
# else
		 extern TModule       		*pNSResModule ;
		 extern Adepul_FU_Dys_FKS	ks ;
# endif

#endif  // __Adepul_FU_Dys_FKS_H__
