...
#ifndef __ADEPUL_FU_DYS_HKS_H__
#define __ADEPUL_FU_DYS_HKS_H__
...
class Adepul_FU_Dys_HKS : public AbstractKS
{
 public:
	Adepul_FU_Dys_HKS() { } ;
	~Adepul_FU_Dys_HKS() { } ;
...
#  else
		 ...
		 Adepul_FU_Dys_HKS        ks ;
#  endif
# else
		 extern TModule       		*pNSResModule ;
		 extern Adepul_FU_Dys_HKS	ks ;
# endif

#endif  // __Adepul_FU_Dys_HKS_H__
