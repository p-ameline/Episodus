...
#ifndef __DPIOCANCERCOLONKS_H__
#define __DPIOCANCERCOLONKS_H__
...
class DPIOCancerColonKS : public AbstractKS
{
 public:
	DPIOCancerColonKS() {
   }
...
#  else
		 ...
		 DPIOCancerColonKS        ks ;
#  endif
# else
		 extern TModule       		*pNSResModule ;
		 extern DPIOCancerColonKS	ks ;
# endif

#endif  // __DPIOCANCERCOLONKS_H__
