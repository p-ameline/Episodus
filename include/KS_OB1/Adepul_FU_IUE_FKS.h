...
#ifndef __ADEPUL_FU_IUE_FKS_H__
#define __ADEPUL_FU_IUE_FKS_H__
...
class Adepul_FU_IUE_FKS : public AbstractKS
{
 public:
	Adepul_FU_IUE_FKS() { } ;
	~Adepul_FU_IUE_FKS() { } ;
...
#  else
		 ...
		 Adepul_FU_IUE_FKS        ks ;
#  endif
# else
		 extern TModule       		*pNSResModule ;
		 extern Adepul_FU_IUE_FKS	ks ;
# endif

#endif  // __Adepul_FU_IUE_FKS_H__
