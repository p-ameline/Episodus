#ifndef __PREOCUPATION__
#define __PREOCUPATION__
...
class PreoccupationDispatching : public AbstractKS
{
public:

	PreoccupationDispatching() { }
...
#  else
		 ...
		 PreoccupationDispatching  ks ;
#  endif
# else
		 extern TModule       		*pNSResModule ;
		 extern PreoccupationDispatching				ks ;
# endif
