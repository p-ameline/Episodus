...
#endif
    NSEpiClasserInfo(const NSEpiClasserInfo& rv) ;
    ~NSEpiClasserInfo() ;
                               ...
                               public NSFiche
{
  public:
    ...
    NSEpiClasser(const NSEpiClasser& rv) ;
    ~NSEpiClasser() ;
...
#endif
{
  public:
    ...
    // constructors/destructor
    NSThesaurusData() ;
    NSThesaurusData(const NSThesaurusData& rv) ;
    ~NSThesaurusData() ;
...
#endif
    NSThesaurusInfo(const NSThesaurusInfo& rv) ;
    ~NSThesaurusInfo() ;
                              ...
                              public NSFiche
{
  public:
    ...
    NSThesaurus(const NSThesaurus& rv) ;
    ~NSThesaurus() ;
...
#endif
{
  ...
  public:
    ...
    NSEpiClassifInfo() ;
#ifndef _ENTERPRISE_DLL
    NSEpiClassifInfo(const NSEpiClassif *) ;
#endif
    NSEpiClassifInfo(const NSEpiClassifInfo& rv) ;
    ~NSEpiClassifInfo() ;
...
class _EPISODUS NSEpiClassif : public NSEpiClassifInfo, public NSFiche
{
  public:
    ...
    NSEpiClassif(const NSEpiClassif& rv) ;
    ~NSEpiClassif() ;
