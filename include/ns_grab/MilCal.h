...
MFTYPE32 MIL_ID MFTYPE McalAlloc(long Mode,
                                 long ModeFlag,
                                 MIL_ID *ContextIdPtr);
MFTYPE32 MIL_ID MFTYPE McalAllocEx(MIL_ID SystemId,
                                   long Mode,
                                   long ModeFlag,
                                   MIL_ID *ContextIdPtr);
...
MFTYPE32 MIL_ID MFTYPE McalRestoreEx(MIL_TEXT_PTR FileName,
                                     MIL_ID SystemId,
                                     long ControlFlag,
                                     MIL_ID * CalibrationIdPtr);
...
MFTYPE32 void MFTYPE McalStream( MIL_TEXT_PTR MemPtrOrFileName,
                                 ...
                                 MIL_ID *ObjectIdPtr                 );
MFTYPE32 void MFTYPE McalStreamEx( MIL_TEXT_PTR MemPtrOrFileName,
                                   MIL_ID SystemId,
                                   long   Operation, long StreamType,
                                   double Version,   long ControlFlag,
                                   MIL_ID *ObjectIdPtr                 );
