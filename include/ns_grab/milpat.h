...
#define M_TEMPLATE            0x00000001L
#define M_NORMALIZED          0x00000002L
#define M_ROTATION            0x00000004L
...
#ifdef  M_MIL_BW_COMPAT  //TBR MIL 8.0
...
#define M_DRAW_BOX              32L   // also used by Mblobdraw and MmeasDraw and Mmoddraw 
#define M_DRAW_POSITION         64L   // also used by Mblobdraw and MmeasDraw and Mmoddraw 
#define M_ORIGINAL             409L  // also used by Mmoddraw 
...
#define M_TARGET_FILTER           49L

#define M_PROC_FIRST_LEVEL        50L
#define M_PROC_LAST_LEVEL         51L
#define M_DEF_PROC_FIRST_LEVEL    50L
#define M_DEF_PROC_LAST_LEVEL     51L

//values
#define M_FILTER_NONE              1L
#define M_FILTER_2X2               2L
#define M_FILTER_3X3               3L
...
#define M_FIND_BEST_MODELS        1
#define M_FIND_ALL_MODEL          2
...
#define M_PAT_ERR_OFFSET                  27000L
#define M_PAT_INVAL_PAR_ERR               0001L+M_PAT_ERR_OFFSET
#define M_PAT_OPERATION_ERR               0002L+M_PAT_ERR_OFFSET
#define M_PAT_MEMORY_ERR                  0003L+M_PAT_ERR_OFFSET
#define M_PAT_ALLOCATION_ERR              0004L+M_PAT_ERR_OFFSET
#define M_PAT_FILE_ERR                    0005L+M_PAT_ERR_OFFSET

#else

#define M_PAT_ERR_OFFSET                  7000L
#define M_PAT_INVAL_PAR_ERR               0001L+M_PAT_ERR_OFFSET+M_FUNC_ERROR
#define M_PAT_OPERATION_ERR               0002L+M_PAT_ERR_OFFSET+M_FUNC_ERROR
#define M_PAT_MEMORY_ERR                  0003L+M_PAT_ERR_OFFSET+M_FUNC_ERROR
#define M_PAT_ALLOCATION_ERR              0004L+M_PAT_ERR_OFFSET+M_FUNC_ERROR
#define M_PAT_FILE_ERR                    0005L+M_PAT_ERR_OFFSET+M_FUNC_ERROR

#endif //M_MIL_BW_COMPAT
