...
//Version:            1.0
//Copyright:          
//Description:        Created by Proxy Wizard and not modified
//Author:             
//Company:            
//
//Header Type:        Abstract type descriptions.
//
//File:               mssoap30_originalProxy.h
//
...
#if !defined(__MSSOAP30_ORIGINALPROXY_H)
#define __MSSOAP30_ORIGINALPROXY_H
...
DECLARE_INTERFACE_(ISequentialStream, IUnknown)
{
	...
	STDMETHOD_(HRESULT, RemoteRead) (THIS_ unsigned char* pv, unsigned long cb, unsigned long* pcbRead) PURE; 
	STDMETHOD_(HRESULT, RemoteWrite) (THIS_ unsigned char* pv, unsigned long cb, unsigned long* pcbWritten) PURE; 
};
...
#endif
	//IStream methods:
	STDMETHOD_(HRESULT, RemoteSeek) (THIS_ _LARGE_INTEGER dlibMove, unsigned long dwOrigin, _ULARGE_INTEGER* plibNewPosition) PURE; 
	STDMETHOD_(HRESULT, SetSize) (THIS_ _ULARGE_INTEGER libNewSize) PURE; 
	STDMETHOD_(HRESULT, RemoteCopyTo) (THIS_ IStream* pstm, _ULARGE_INTEGER cb, _ULARGE_INTEGER* pcbRead, _ULARGE_INTEGER* pcbWritten) PURE; 
	STDMETHOD_(HRESULT, Commit) (THIS_ unsigned long grfCommitFlags) PURE; 
	STDMETHOD_(HRESULT, Revert) (THIS ) PURE; 
	STDMETHOD_(HRESULT, LockRegion) (THIS_ _ULARGE_INTEGER libOffset, _ULARGE_INTEGER cb, unsigned long dwLockType) PURE; 
	STDMETHOD_(HRESULT, UnlockRegion) (THIS_ _ULARGE_INTEGER libOffset, _ULARGE_INTEGER cb, unsigned long dwLockType) PURE; 
	STDMETHOD_(HRESULT, Stat) (THIS_ tagSTATSTG* pstatstg, unsigned long grfStatFlag) PURE; 
...
class _PWCLASS TISoapSerializerProxy : public TAutoProxy
{
public:
	TISoapSerializerProxy() : TAutoProxy(0x0) {}
...
class _PWCLASS TISoapClientProxy : public TAutoProxy
{
public:
	TISoapClientProxy() : TAutoProxy(0x0) {}
...
class _PWCLASS TISoapConnectorProxy : public TAutoProxy
{
public:
	TISoapConnectorProxy() : TAutoProxy(0x0) {}
