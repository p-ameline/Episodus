...
#include "nsbb\nsednum.h"
#include "nssavoir\nspatho.h"
#include "nsmt_vidalApi\vidalApiMaster.h"

//
// Objet "Boite de dialogue" utilisé pour sélectionner l'utilitaire
//
class NsVidalApiDialog : public NSUtilDialog
{
  public:

    VidalApiMaster* _pMaster ;

    OWL::TCheckBox*	_pProcessMedicaBase ;

    NsVidalApiDialog(TWindow* pere, NSContexte* pCtx, VidalApiMaster* pMaster) ;
    ~NsVidalApiDialog() ;
    ...
    void startMedicaBase() ;
    void buildUnitsFile() ;

  DECLARE_RESPONSE_TABLE(NsVidalApiDialog) ;
} ;
