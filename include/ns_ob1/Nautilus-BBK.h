...
// fab - septembre 2002
// -----------------------------------------------------------------------------
// Ce fichier définit les prototypes des fonctions d'initialisation du
// Blackboard. On définit aussi les fonctions permettant la communication entre
...
// ajoute des données provenant de Nautilus sur le Blackboard
...
void      __export CheckZeroObjectCount(NSSuper *pSuper, string sObjectName, long lInstanceCounter) ;
...
void      CheckZeroObjectCount(NSSuper *pSuper, string sObjectName, long lInstanceCounter) ;
