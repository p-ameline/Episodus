...
class NSLdvToon : public NSRoot
{
  private:
    ...
    NSLdvToon(NSContexte* pCtx, NSLdvView* pTheView) ;
...
class ArrayOfToons : public ArrayLdvToon
{
	public:
