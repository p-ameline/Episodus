...
class NSLdvWindowToon : public NSLdvToon
{
	public :
    ...
    NSLdvWindowToon(NSContexte* pCtx, NSLdvWindowToon* parent, NSLdvView* pTheView) ;
...
class NSLdvCommandPannel : public NSLdvWindowToon
{
  protected:
  ...
  public:
    ...
    NSLdvCommandPannel(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvView* pTheView) ;
...
class NSLdvCommandPannelInterface : public TWindow, public NSRoot
{
  public:
...
class NSLdvChronoLine : public NSLdvWindowToon
{
  public:

    NSLdvChronoLine(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvView* pTheView) ;
...
class NSLdvChronoLineInterface : public TWindow, public NSRoot
{
  public:
...
class NSLdvCurveYAxis : public NSLdvWindowToon
{
  public:
    ...
    NSLdvCurveYAxis(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvView* pTheView, NSLdvCurve* pTheCurve) ;
...
class NSLdvCurveYAxisInterface : public TWindow, public NSRoot
{
  public:
...
class NSLdvCurveBackgroundQuadri
{
  public:
    ...
    NSLdvCurveBackgroundQuadri(NSLdvView* pVw) ;
    // Ctor for rectangular quadri
    NSLdvCurveBackgroundQuadri(NSLdvView* pVw, NS_CLASSLIB::TColor qColor, NVLdVTemps beginDate, NVLdVTemps endDate, double lowerValue, string lowerUnit, double upperValue, string upperUnit) ;
...
class NSLdvCurveBackground : public NSLdvTimeToon
{
  public:
...
class NSCurvesProperty : public NSLdvWindowToon
{
  protected:
  ...
  public:
    ...
    NSCurvesProperty(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvView* pTheView) ;
...
class NSCurvesPropertyWindow : public TListWindow, public NSRoot
{
  public:
...
class NSLdvCurvesManagementPannel : public NSLdvWindowToon
{
  public:

    NSLdvCurvesManagementPannel(NSContexte* pCtx, NSLdvWindowToon* pLdvParent, NSLdvView* pTheView) ;
...
class NSLdvCurvesManagementPannelInterface : public TWindow, public NSRoot
{
  public:
...
// Icons window
//
class NSLdvViewIconsShowWindow : public TWindow, public NSRoot
{
  protected:
