// --------------------------------------------------------------------------// NSEPISOD.H		Document/Vues Capture Données Utilisateur
// --------------------------------------------------------------------------
...
class NSEpisodus : public NSRoot
{
    public:
        ...
        // tableau correspondant à la capture
        ...
        EpisodusModel           *pCurrentModel;  // pointeur sur le modèle courant
    ...
    protected:
        ...
        bool        bStateOn;                       // état du module Episodus
        bool        bMouseHookState;                // état du hook
        bool        bModelFound;                    // modèle trouvé
