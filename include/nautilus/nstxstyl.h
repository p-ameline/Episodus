...
/*
class NSStyleDecorArray : public NSNSStylDecoArray

{
	...
	NSStyleDecorArray() : NSNSStylDecoArray() {}

	NSStyleDecorArray(NSStyleDecorArray& rv);
   ...
   int 					 operator==(NSStyleDecorArray& o);
...

{
  ...
  /*
class  NSDecorArray : public NSNSDecoArray

{
	...
	NSDecorArray() : NSNSDecoArray() {}

	NSDecorArray(NSDecorArray& rv);
   ...
   copier(NSDecorArray* src);



   int 			  operator==(NSDecorArray& o);
