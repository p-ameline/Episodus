...
#endif
{
  public :
    ...
    NSPathoArray(const NSPathoArray& rv) ;
    // Destructeur
...
class NSListPathoInfo : public NSPathologInfo
{
  public :
    ...
    bool ammorce ;
		...
		NSListPathoInfo(const NSListPathoInfo& rv) ;
    ~NSListPathoInfo() ;
...
typedef NSListPathoInfoArray::const_iterator constIterNSListPathoInfoArray ;
...
class NSListPathoArray : public NSListPathoInfoArray
{
  public :
    ...
    NSListPathoArray(const NSListPathoArray& rv) ;
    // Destructeur
...
#endif // _INCLUS
{
  public:
    ...
    void ElementPrecedent() ;      //selection de l'element precedent
    void ElementSuivant() ;        //selection de l'element suivant
    void LexiqueMedicament() ;
    void LexiqueGeneral() ;
    ...
    void setEdit(NSEditDicoGlobal* pE, string sTypeLexiq = string("")) { _pEdit = pE ; _sTypeLexique = sTypeLexiq ; }
    void EvClose() ;
    void EvDestroy() ;
    void CmOk() ;
    void CmCancel() ;
