...
// NSRightsDefs.H
// -----------------------------------------------------------------------------
// Définitions du manager des droits des utilisateurs
// -----------------------------------------------------------------------------
// $Revision: 1.3 $
// $Author: pameline $
// $Date: 2014/05/01 17:06:17 $
// -----------------------------------------------------------------------------
// FLP - juin 2004
// CH  - mai 2004
// -----------------------------------------------------------------------------
...
DistanceType getDistanceFromInt(int iDistanceAsInt)
{
  switch(iDistanceAsInt)
  {
    case 0  : return patDist ;
    case 1  : return nearDist ;
    case 2  : return farDist ;
    case 3  : return farAwayDist ;
    default : return DTnotDef ;
  }
}

// La specialité de l'utilisateur :
//   la meme specialité ou une specialité différente
enum SpecialityType { STnotDef = -1, sameSpec, difSpec } ;

// Le metier. Les utilisateurs du personnel de santé ou du social ont encore
// un parametre (sameTrade) qui mentionne s'ils ont le même métier ou non avec
// l'utilisateur qui a créé le documment
