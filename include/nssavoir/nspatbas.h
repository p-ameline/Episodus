...
#endif
{
  protected:
	...
	public :
		...
		bool   sameContent(const NSPathoBaseData& o) const ;
    bool   sameContentButInterest(const NSPathoBaseData& o) const ;
    ...
    int 			       operator==(const NSPathoBaseData& o) const ;
} ;
