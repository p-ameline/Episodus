...
class NSUpDownHeure : public OWL::TUpDown, public NSRoot
{
 public:

  // constructors/destructor
  NSUpDownHeure(NSContexte *pCtx, TWindow *windowParent, int resId, NSUpDownHeureEdit *parent) ;
  NSUpDownHeure(NSContexte *pCtx, TWindow *windowParent, int Id, int x, int y, int w, int h, NSUpDownHeureEdit *parent) ;
  ~NSUpDownHeure() ;
...
class NSEditHeureMedic : public NSEditHeure
{
 public:
  ...
  NSEditHeureMedic(NSContexte *pCtx, TWindow *windowParent, int resId, NSUpDownHeureEdit *parent, string sUserLang) ;
  NSEditHeureMedic(NSContexte *pCtx, TWindow *windowParent, int Id, const char far *text, int x, int y, int w, int h, NSUpDownHeureEdit *parent, string sUserLang) ;
  ~NSEditHeureMedic() ;
...
class NSUpDownHeureEdit : public NSRoot
{
 public:
  // constructors/destructor
    NSUpDownHeureEdit(NSContexte *pCtx, TWindow *windowParent, int resEditId, int resUpDownId, string sUserLang) ;
    NSUpDownHeureEdit(NSContexte *pCtx, TWindow *windowParent, int resEditId, int resUpDownId, const char far *text, int x, int y, int w, int h, string sUserLang) ;
...
class NSUpDownEditHeureControle : public NSRoot
{
 public:
...
//------------------------------------------------------------------------------
class NSUpDownEditLexiqueControl : public NSRoot
{
	public:
  // constructors/destructor
...
class NSTexteLibre  : public OWL::TEdit, public NSRoot
{
 public:
...
// Evaluation du DUSOI
//
class _NSBBCLASSE NSFreeTextDlg : public NSUtilDialog
{
 public:

  NSTexteLibre* _pFreeText ;
  string*       _pText ;

  NSFreeTextDlg(TWindow* pPere, NSContexte* pCtx, string* pText) ;
  ~NSFreeTextDlg() ;
  ...
  void SetupWindow() ;
	...
	DECLARE_RESPONSE_TABLE(NSFreeTextDlg) ;
};
...
//------------------------------------------------------------------------------
class NSCheckBoxControle : public OWL::TCheckBox, public NSRoot
{
 public:
...
//------------------------------------------------------------------------------
class NSRadioButtonControle : public OWL::TRadioButton, public NSRoot
{
 public:
