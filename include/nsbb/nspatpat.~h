...
#endif
{
  ...
  public:
    ...
    int             operator==(const NSPatPathoData& o) const ;
    int              operator!=(const NSPatPathoData& o) const	{ return !(*this == o) ; }

    void            metAZero() ;
    bool            sameContent(const NSPatPathoData* pPathoData) const ;
    bool            sameContentButInterest(const NSPatPathoData* pPathoData) const ;
    bool            estEgal(const NSPatPathoData* pPathoData) const ;
    bool            estMemeNode(const NSPatPathoData* pPathoData) const ;
...
#endif
{
  public:
    ...
    ~NSLinkedNode() ;
    NSLinkedNode(const NSLinkedNode& rv) ;
...
typedef NSLinkedNodeVector::const_iterator	NSLinkedNodeConstIter ;
...
#endif
{
  public:
    ...
    NSLinkedNodeArray(const NSLinkedNodeArray& rv) ;
...
#endif
{
  ...
  // Identificateur unique
    ...
    bool            sameContent(const NSPatPathoInfo* pPathoInfo) const ;
    bool            sameContentButInterest(const NSPatPathoInfo* pPathoInfo) const ;
    bool 	        	estEgal(const NSPatPathoInfo* pPathoInfo) const ;
    bool            estMemeNode(const NSPatPathoInfo* pPathoInfo) const ;
    ...
    int		        	operator==(const NSPatPathoInfo& o) const ;
    int             operator!=(const NSPatPathoInfo& o) const	{ return !(*this == o) ; }
...
#endif
{
  ...
  public:
    ...
    void							vider() ;
    void							clearAllIDs() ;
    void							clearDocAndNodeIDs() ;

    void              sorting() ;

    // Operateurs
    NSPatPathoArray&	operator=(const NSPatPathoArray& src) ;
    int		            operator==(const NSPatPathoArray& o) const ;
    int               operator!=(const NSPatPathoArray& o) const	{ return !(*this == o) ; }
    ...
    string        getFreeTextValue(PatPathoIter* pLocalFatherIter) ;
    ...
    bool 	        estEgal(const NSPatPathoArray* pPatho) const ;
    bool 	        hasSameContent(const NSPatPathoArray* pPatho) const ;
    bool 	        hasSameContentButInterest(const NSPatPathoArray* pPatho) const ;
    ...
    PatPathoIter	    ChercherFrereSuivant(PatPathoConstIter iter) ;
