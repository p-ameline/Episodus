...
#endif
{
    public :
		...
		NSObjectData(const NSObjectData& rv) ;

		NSObjectData& operator=(const NSObjectData& src);
...
#endif
{
  public :
    ...
    // Objet qui contient les donnees
		...
		NSObjectDatInfo(const NSObjectDatInfo& rv) ;

    string getID()   { return pDonnees->getID() ; }
    string getNode() { return pDonnees->getNode() ; }

		NSObjectDatInfo& operator=(const NSObjectDatInfo& src) ;
...
#endif
{
  public :
    ...
    NSObjectDatArray(const NSObjectDatArray& rv) ;
    //
    // Destructeur
    //
    ~NSObjectDatArray() ;
    ...
    // Operateurs
    //
    NSObjectDatArray& operator=(const NSObjectDatArray& src) ;
    //
...
#endif
{
    public :
		...
		NSObjectLocData(const NSObjectLocData& rv);

		NSObjectLocData&    operator=(const NSObjectLocData& src);
...
#endif
		NSObjectLocInfo(const NSObjectLocInfo& rv) ;

		NSObjectLocInfo&    operator=(const NSObjectLocInfo src) ;
...
#endif
{
  public :
    ...
    NSObjectLocArray(const NSObjectLocArray& rv);
    //
    // Destructeur
    //
    ~NSObjectLocArray();
    ...
    // Operateurs
    //
    NSObjectLocArray& operator=(const NSObjectLocArray& src);
    //
    // Fonctions de gestion du vecteur
    //
...
#endif
{
  public :
    ...
    //
        ...
        NSObjectTLibreData(const NSObjectTLibreData& rv);
	    NSObjectTLibreData() { metAZero(); }

        ~NSObjectTLibreData();

        NSObjectTLibreData& operator=(const NSObjectTLibreData& src);
...
#endif
		NSObjectTLibreInfo(const NSObjectTLibreInfo& rv);
        ~NSObjectTLibreInfo();

		NSObjectTLibreInfo& operator=(const NSObjectTLibreInfo& src);
...
#endif
{
  public :
    ...
    NSObjectTLibreBase(const NSObjectTLibreBase& rv);
    ~NSObjectTLibreBase();

    NSObjectTLibreBase& operator=(const NSObjectTLibreBase& src);
