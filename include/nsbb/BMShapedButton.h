...
**> Legal issues :
              ...
              Copyright (C) 1998, 1999 by Boian Mitov
              <mitov@mitov.com>
              <http://www.mitov.com>
...
****************************************************************************
Modifications by Eric DUPONT (roderic@club-internet.fr) marked as follow :
//---> Begin ED
// End ED
****************************************************************************
...
//	void __fastcall SetGlyphMask(Graphics::TBitmap* Value);
   ...
   // End ED
	...
	HIDESBASE MESSAGE void __fastcall WMCancelMode(Messages::TWMNoParams &Message);
        ...
        void __fastcall PlayPulseSound();
        void __fastcall PlayHighlightSound();
        void __fastcall PlaySelectSound();
...
//    __property bool   EnableCloud                       = { read=FEnableCloud, write=SetEnableCloud, default=true };
        __property TBMCloudType CloudType                   = { read=FCloudType, write=SetCloudType, default=ctLarge };
