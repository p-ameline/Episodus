...
*/
class _CLASSUTIL TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
*/
class _CLASSUTIL TiXmlAttribute : public TiXmlBase
{
...
*/
class _CLASSUTIL TiXmlElement : public TiXmlNode
{
public:
...
/**	An XML comment.
*/
class _CLASSUTIL TiXmlComment : public TiXmlNode
{
public:
...
*/
class _CLASSUTIL TiXmlText : public TiXmlNode
{
	friend class TiXmlElement;
public:
	/// Constructor.
...
*/
class _CLASSUTIL TiXmlDocument : public TiXmlNode
{
public:
