...
class _NSDKDCLASSE NSPhraseLesion : public NSPhraseObjet
{
    ...
    NSPhraseObjArray MetaLocalisations ;  // Pour les défauts structurels,
    ...
    NSPhraseObjArray Semiologie ;     // Symptômes

    NSPhraseObjArray SousLesions ;    // Lésions asociées

    NSPhraseObjArray Traitements ;    // Traitement
    NSPhraseObjArray CAS ;            // Conduite à suivre
...
class _NSDKDCLASSE NSPhraseOrgane : public NSPhraseObjet
{
    ...
    NSPhraseObjArray Dimensions ;     // Mesures X, Y, Z
    NSPhraseObjArray Lesions ;        // Lésions
    NSPhraseObjArray Aspect ;         // Description
...
class _NSDKDCLASSE NSPhraseTemporel : public NSPhraseObjet
{
    ...
    bool             bMinNow ;      // De maintenant à plus tard
    NSPatPathoInfo   ValeurMax ;    // Valeur max
    bool             bMaxNow ;      // D'une date à maintenant
...
class _NSDKDCLASSE NSPhraseTempoCycle : public NSPhraseObjet
{
    ...
    NSPatPathoInfo  eventDuration ;     // durée de l'événement
    NSPatPathoInfo  cycleDuration ;     // durée du cycle
    int             iEventNb ;          // Nombre d'événements
...
class _NSDKDCLASSE NSPhraseCycle : public NSPhraseObjet
{
    ...
    NSPhraseObjArray    Cycle_circadien ;           // Horaire et quantité d'une prise
...
class _NSDKDCLASSE NSPhrasePrise : public NSPhraseObjet
{
    ...
    NSPatPathoInfo  ObjetDose ;     // Forme   : 2 comprimés

    NSPatPathoInfo  Moment ;        // le matin
    NSPhraseMotTime Temporalite ;   // A 2 heures, (2 heures après le lever ?)
...
class _NSDKDCLASSE NSPhrasePrescript : public NSPhraseObjet
{
    public :
        ...
        int                 iQuantiteJour ;
        NSPhraseObjArray    PrisesJour ;           // Horaire et quantité d'une prise
...
class _NSDKDCLASSE NSPhraseBiometrie : public NSPhraseObjet
{
    ...
    NSPhraseObjArray Localisation ;   // Où
