...
// -----------------------------------------------------------------------------
NSLdvGoal::NSLdvGoal(NSContexte *pCtx, NSLdvDocument *pDocum, LDVFRAME iFrame)
          :NSRoot(pCtx)
{
try
{
...
bool
NSLdvGoal::createXmlTree(NSLdvDocument *pDocLdv, Ctree* pTreeObject, string sTargetLocalisation, bool bRemoveTitle)
{
  if ((NULL == pDocLdv) || (NULL == pTreeObject))
		return false ;
