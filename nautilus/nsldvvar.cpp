...
try
{
  ...
  NSLdvDocument *pDoc = _pLdvDoc ;
  if ((NULL == pDoc) && _pLdvView)
    pDoc = _pLdvView->getDoc() ;

  if ((NSLdvDocument*) NULL == pDoc)
    return ;
...
NSNewRiskDlg::NSNewRiskDlg(NSLdvView* pView, NSContexte* pCtx, NewConcernInfo *pNewConcernInfo)
...
NSNewSocialDlg::NSNewSocialDlg(NSLdvView* pView, NSContexte* pCtx, NewConcernInfo *pNewConcernInfo)
...
NSModifConcernDlg::NSModifConcernDlg(LDVFRAME iFrame, NSLdvView* pView, NSContexte* pCtx, NSConcern* pPb)
